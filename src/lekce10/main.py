...
while not done:
    ...
    print(
        f"Q-values:  Up (0): {q_table[row, col, 0]:.2f} | Down (1): {q_table[row, col, 1]:.2f} | Left (2): {q_table[row, col, 2]:.2f} | Right (3): {q_table[row, col, 3]:.2f}"
    )
